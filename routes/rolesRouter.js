...
const { createRole, getAllRoles, getRoleById, createInviteCode, editRole, getAllRolesNames } = require('../controller/rolesController');
...
router.get('/names',isAuth,getAllRolesNames)
